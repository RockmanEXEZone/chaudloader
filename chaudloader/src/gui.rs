...
fn make_main_tile(
    ...
    let open_folder_button = fltk::button::Button::default()
                ...
                Ok(mod_bindings) => mod_bindings
                    ...
                    .map(|(name, r#mod)| {
                        (
                            ...
                            ModBinding {
                                r#mod,
                                enabled: currently_enabled.contains(&name),
                            },
                        )
                    })
                    .collect(),
            ...
            Ok(mod_bindings) => mod_bindings
                ...
                .map(|(name, r#mod)| {
                    (
                        ...
                        ModBinding {
                            r#mod,
                            enabled: config.enabled_mods.contains(&name),
                        },
                    )
                })
                .collect(),
...
fn make_window(
    ...
    let main_tile = make_main_tile(config, {
